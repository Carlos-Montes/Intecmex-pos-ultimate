<div class="modal fade" id="categories-{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <select name="status" id="status" class="form-select" @if($item->parent_id != 0 || $item->children->count() == 0) disabled @endif>
